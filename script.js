...
function displayJudgeAnswers(
    ...
    submittedPlayers.forEach(
        ([playerId, player]) => {
            ...
            // ==========================================
            // OTHERWISE CREATE CARD WITH JAVASCRIPT
            // ==========================================
...
async function chooseWinner(
    ...
    try {
        ...
        // Disable buttons so the judge
        // cannot select multiple winners
        const buttons =
            document.querySelectorAll(
                ".chooseAnswer"
            );
